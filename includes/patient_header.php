...
<div class="row" style="padding-left:25px; padding-right:25px; padding-top:45px; padding-bottom:25px;">
  ...
  <div class="col-sm-3" style="padding-left:45px; padding-right:20px; padding-top:0; padding-bottom:5px;">
    ...
    <div class="btn-group-vertical">
      <p>
        <a href="../patient/find.php" class="btn btn-info">
          <span class="glyphicon glyphicon-plus"></span> Find Doctors 
        </a>

        <a href="../patient/pastrecords.php" class="btn btn-info">
          <span class="glyphicon glyphicon-plus"></span> Past Records
        </a>
